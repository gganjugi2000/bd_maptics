...
// 컴포넌트 정의
const CampaignInfo = ({ advertiserInfo, campaignInfo, campaignAcknlg, onSubmit, onDelete, onCancel, handleAdvtsSearchPopupOpen }) => {
    ...
    useEffect(() => {
        if(!isEmpty(campaignInfo)){
            setCampaign({
                ...
                , cmpgn_title: campaignInfo.cmpgn_title
                , cmpgn_pps: campaignInfo.cmpgn_pps
                , send_req_cnt: campaignInfo.send_req_cnt
                , send_dt_ymd: (campaignInfo.send_dt_ymd ? Date.parse(campaignInfo.send_dt_ymd) : null)
                , send_dt_ap: (campaignInfo.send_dt_ap ? { value: campaignInfo.send_dt_ap, label: campaignInfo.send_dt_ap } : null)
                , send_dt_hh: (campaignInfo.send_dt_hh ? { value: campaignInfo.send_dt_hh, label: campaignInfo.send_dt_hh } : null)
                , send_dt_mm: (campaignInfo.send_dt_mm ? { value: campaignInfo.send_dt_mm, label: campaignInfo.send_dt_mm } : null) 
                , use_cm: campaignInfo.use_cm
                , send_mode: campaignInfo.send_mode
                , mgs_title: campaignInfo.mgs_title
    ...
    const downloadUrlUploadForm = (e) => {
        console.log("downloadUrlUploadForm ================== ")
        console.log(e)
    }

    const downloadCpNoUploadForm = (e) => {
        console.log("downloadCpNoUploadForm ================== ")
        console.log(e)
    }
    ...
    const handleSubmit = (e) => {
        ...
        console.log(cmpgnTitleValid)
        console.log(cmpgnPpsValid)
        console.log(sendReqCntValid)
        console.log(sendDtYmdValid)
        console.log(sendDtApValid)
        console.log(sendDtHhValid)
        console.log(sendDtMmValid)
        console.log(sendModeValid)
        console.log(mgsTitleValid)
        console.log(msgSummaryValid)
        console.log(senderNoValid)
        console.log(rctTargetValid)
        console.log("----------------------------------------------------------------")
        console.log("valid msg ==========================================================")
        console.log(advtsIdMsg)
        console.log(cmpgnTitleMsg) 
        console.log(cmpgnPpsMsg)
        console.log(sendReqCntMsg) 
        console.log(sendDtYmdMsg)
        console.log(sendDtApMsg) 
        console.log(sendDtHhMsg)
        console.log(sendDtMmMsg)
        console.log(sendModeMsg) 
        console.log(mgsTitleMsg)
        console.log(msgSummaryMsg)
        console.log(senderNoMsg) 
        console.log(rctTargetMsg) 
        console.log("----------------------------------------------------------------")
        ...
        formData.append("advts_id", campaign.advts_id);
        formData.append("cmpgn_id", campaign.cmpgn_id);
    ...
    if(campaignInfo === undefined || campaignInfo === null) {
        return <div></div>
    }
    ...
    return (
        <div className={cx("regist_box")}>
            ...
            <span className={cx("add_title")} >등록 정보</span>
                <table className={cx("mt10", "mb20")} >
					...
					<tbody>
						<tr>
							<th scope="row"><label2 for="PTjoin_name" className={cx("label2")}>등록일시</label2></th>
							<td colSpan="3">
                                <InputText 
                                    id="reg_dt"
                                    size="27"
                                    value={campaign.reg_dt}
                                    readOnly
                                />
							</td>
						</tr>
						<tr>
							<th scope="row"><label2 for="PTjoin_name" className={cx("label2")}>수정일시</label2></th>
							<td colSpan="3">
                                <InputText 
                                    id="udt_dt"
                                    size="27"
                                    value={campaign.udt_dt}
                                    readOnly
                                />
                            </td>
						</tr>
						<tr>
							<th scope="row"><label2 for="PTjoin_name" className={cx("label2")}>상태</label2></th>
							<td>
                                <InputText 
                                    id="email_addr"
                                    size="27"
							...
							<th scope="row"><label2 for="PTjoin_name" className={cx("label2")}>승인확인</label2></th>
							<td>
                            </td>
						</tr>
					</tbody>
